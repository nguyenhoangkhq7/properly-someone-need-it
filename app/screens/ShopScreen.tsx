    ...
    import type { RootStackParamList } from "../navigator/RootStack"; // kiểu stack
    ...
    type ShopScreenRouteProp = RouteProp<RootStackParamList, "ShopScreen">;
    ...
    return (
        ...
        <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
            {/* Ảnh bìa */}
            <ImageBackground
            source={{ uri: shop.avatar || "https://placehold.co/600x250/11120F/F6FF00?text=Cover" }}
